          ...
          <div className="row align-items-center">
            ...
            <div className="col-12 col-md-4">
              <div className="footer-widget">
                ...
                <p>
                  Phone : <a href="tel:+98 698 5874 5896">+98 698 5874 5896</a>
                </p>
                <p>
                  Email : <a href="mailto:demo@mail.com">demo@mail.com</a>
                </p>
          ...
          <div className="row">
            <div className="col-12 d-md-flex text-center">
              <div className="copyright-text">
                <p>
                  &copy; Copyright <span id="currentYear"></span> RM Template by{' '}
                  <a href="https://regaltheme.com" target="_blank">
                    Regaltheme
                  </a>
                </p>
              </div>
